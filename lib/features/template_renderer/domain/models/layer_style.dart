...
class LayerStyle {
  ...
  const LayerStyle({
    ...
    this.shadowColorHex = 0x00000000,
    this.shadowDx = 0.0,
    this.shadowDy = 0.0,
  ...
  factory LayerStyle.fromJson(Map<dynamic, dynamic> rawJson) {
    ...
    return LayerStyle(
      ...
      shadowColorHex: _parseHex(shadowVal, 0x00000000),
      shadowDx: ((json['shadowDx'] ?? json['shadow_dx']) as num?)?.toDouble() ?? 0.0,
      shadowDy: ((json['shadowDy'] ?? json['shadow_dy']) as num?)?.toDouble() ?? 0.0,
      shadowBlurRadius: ((json['shadowBlurRadius'] ?? json['shadow_blur_radius']) as num?)?.toDouble() ?? 0.0,
