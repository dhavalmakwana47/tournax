...
class _EditTeamPageState extends ConsumerState<EditTeamPage> {
  ...
  Future<void> _loadTeam() async {
    final team = await ref
        ...
        .fetchTeam(widget.team.id);
    if (!mounted) return;
    _nameCtrl.text = (team ?? widget.team).name;
  ...
  Future<void> _submit() async {
    ...
    notifier.resetUpdateTeamStatus();

    final success = await notifier.updateTeam(
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            const Text('Edit Team', style: AppTextStyles.titleMedium),
          ...
          : Padding(
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    Text('Team Name', style: AppTextStyles.bodyMedium),
